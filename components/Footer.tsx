...
const Footer = () => {
  return (
    <footer className='FlexStart footer'>
      <div className='flex flex-col gap-12 w-full'>
        <div className='flex items-start flex-col'>
          <Image src={"/logo-purple.svg"}
            width={115} height={0}
            alt='Flexible content' />

          <p className='text-start text-sm font-normal mt-5 max-w-xs'>
            Flexible is the word's leading comunity for creatives to
      ...
      <div className="flexBetween footer_copyright pt-12">
        <p>@ 2023 Flexible. Allrights resevered</p>
